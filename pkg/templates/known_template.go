...
const (
	...
	SYSTEM_PROMPT_RECEIPT_ITEM_RECOGNITION           KnownTemplate = "prompt/receipt_item_recognition"
	...
	SYSTEM_PROMPT_BATCH_RECEIPT_ITEM_RECOGNITION     KnownTemplate = "prompt/batch_receipt_item_recognition"
)
